...
urlpatterns = [
    ...
    path("dishes/<int:pk>/add/", DishAddCookView.as_view(), name="dish-add"),
    path("dishes/<int:pk>/remove/", DishRemoveCookView.as_view(), name="dish-remove"),
    path("dishes/<int:pk>/update-ingredient/", DishUpdateIngredientView.as_view(), name="dish-update-ingredient"),
